...
2 develop saas systems which run on linux but interact with   ms office and ms viewport desktops so very little interaction with newworld
3 1 . the new ocp organization and partner engagement strategy is slow to be implemented . our company has been waiting for 8 months ( still counting ) before we are fully enrolled as a co  sell ready partner . internal processes related to p  seller enrollment are extremely slow , no one seems to have any control of it in the field . 2 . account executive are not responding despite the fact that ocp partner engagement managers do the go between 3 . the way the newworld org is supposed to work is not clear : ocp vs csu vs enterprise : who is really in charge of deployments ? 4 . ms services strategy has become very unclear . we used to partner deeply with ms services . now , everything seems to be broken since the beginning of fy18
4 office365 is too expensive . i would like to put our domain and all our office , communication and exchange stuff into the ms cloud , but for a company with 11 employees in software development business all third party libs and services are too much . your premium devices are also   … are … pricy . :-}
...
3 1 . the new ocp organization and partner engagement strategy is slow to be implemented . our company has been waiting for 8 months ( still counting ) before we are fully enrolled as a co  sell ready partner . internal processes related to p  seller enrollment are extremely slow , no one seems to have any control of it in the field . 2 . account executive are not responding despite the fact that ocp partner engagement managers do the go between 3 . the way the newworld org is supposed to work is not clear : ocp vs csu vs enterprise : who is really in charge of deployments ? 4 . ms services strategy has become very unclear . we used to partner deeply with ms services . now , everything seems to be broken since the beginning of fy18
4 develop saas systems which run on linux but interact with   ms office and ms viewport desktops so very little interaction with newworld
5 office365 is too expensive . i would like to put our domain and all our office , communication and exchange stuff into the ms cloud , but for a company with 11 employees in software development business all third party libs and services are too much . your premium devices are also   … are … pricy . :-}
